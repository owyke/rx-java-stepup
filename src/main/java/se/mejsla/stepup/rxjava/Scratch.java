...
public class Scratch {
    ...
    public static void main(String[] args) {
        ...
        Action1 errorHandler = (e) -> System.out.println("Cannot divide with zero, RTFM!");;
    ...
    private static void iterateEm(Iterable<Integer> ints, Action1<Integer> elementHandler, Action1 errorHandler, Action0 finishedHandler) {
        try {
    ...
    private static void observeEm(Iterable<Integer> ints, Action1<Integer> elementHandler, Action1 errorHandler, Action0 finishedHandler) {
